...
if selected == "Техническая заявка":
	if check_password():
		st.title(f"{selected}")
		df = pd.read_excel("https://docs.google.com/spreadsheets/d/e/2PACX-1vTCMxcnRKh9hpA3PxwjtyAmZWuOE1py_Z0VDU_KYIwbbqJjLGTfpRcj9PNTGsJweIEAttJsXfYbK2vu/pubhtml", 
